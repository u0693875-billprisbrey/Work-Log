# Email for week starting 03.09.2026  
...
explanations <- c("Job Mngt" = "Computer service; compliance courses; enabling Oracle client; UAIR meetings; weekly log; Jira; resolving GitHub issues", 
                  "Predict Math Success" = "Small adjustments to Phase 1 report",
                  "PI Turnover" = "",
                  "Gray DI" = "Monthly meeting; outlining initial impressions and questions",
                  "Prof Dev" = "Studying new machine learning workflow (tidyverse, tidymodels, xgboost); reviewing ML books",
                  "Travel" = "Computer service",
                  "Fitness Challenge" = "Daily walking"
                  )  
