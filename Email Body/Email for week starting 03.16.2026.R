# Email for week starting 03.16.2026  
...
explanations <- c("Job Mngt" = "Daily planning; weekly logs; UAIR meetings", 
                  "Predict Math Success" = "Presentation in monthly Student Success meeting",
                  "PI Turnover" = "",
                  "Gray DI" = "Training series; discussing with Ben",
                  "Prof Dev" = "Studying new machine learning workflow (reviewing ML books and new functions)"
)  
...
assignments <- 
  "
* Create Epic for 'Predict Completions' DONE 
...
* Update select models using 'tidymodels' and 'xgboost' (instead of 'caret')
* Update Phase 1 report per feedback  DONE
...
* Develop Gray DI analytical approach based on internal objectives and data availability   
"
