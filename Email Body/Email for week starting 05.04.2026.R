# Email for week starting 05.04.2026  
...
explanations <- c("Job Mngt" = "UAIR learning hour; returning old laptop", 
                  "Travel" = "Returning old laptop",
                  "Forecast Completion Rates" = "Simple extrapolation report; abandoned as historical IPEDS numbers cannot be matched; working with raw numbers going forward; agentic AI drafts on individual- and cohort- level forecasts" 
)  
...
* Attend IR meetings and learn about reporting definitions DONE
* Develop forecast from FTF Demo data, disregarding other data sources IN PROGRESS
"

agendaItems <- 
  "
  Individual forecast report in progress; discuss accuracy and utilty.
  Develop features from Courses data
"

nextSteps <- 
  "
* Develop baseline forecast using historical proportions (stratifying by gender and declared major) ABANDONED
