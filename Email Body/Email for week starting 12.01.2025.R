# Email for week starting 12.01.2025
...
explanations <- c("Job Mngt" = "Planning; log; UAIR meeting", "Predict Math Success" = "Predicting 'W' and low grades; Polishing 'predictors over time' report; Starting 'gentle guidance' through IQR graphic")
