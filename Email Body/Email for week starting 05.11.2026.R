# Email for week starting 05.11.2026  
...
explanations <- c("Job Mngt" = "UAIR Meetings (All Staff; Student Success); weekly logs; Jira", 
                  "Travel" = "To UAIR All Staff Meeting",
                  "Forecast Completion Rates" = "Preliminary individual level forecast completed; iterating on improvements with Ellmer agentic AI" 
)  
...
agendaItems <- 
  "
* Draft report of individual level completion forecasts   
