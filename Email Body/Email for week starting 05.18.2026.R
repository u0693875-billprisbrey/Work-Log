# Email for week starting 05.18.2026  
...
explanations <- c("Job Mngt" = "UAIR Meetings; weekly logs; Jira",
                  # "Holiday" = "Memorial Day",
                  # "Sick" = "Dr Appt",
                  # "Travel" = "Internal networking",
                  "Forecast Completion Rates" = "Diagnostics, plots, double-checking, and de-bugging" 
)  
