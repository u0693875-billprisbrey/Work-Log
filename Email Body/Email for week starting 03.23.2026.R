# Email for week starting 03.23.2026  
...
explanations <- c("Job Mngt" = "Daily planning; weekly log; UAIR meetings", 
                  "Predict Math Success" = "Phase 2 sneak preview graphic; Re-training and optimizing model without caret; deep dive report",
                  "PI Turnover" = "",
                  "Gray DI" = "Training series; Q&A during office hrs; developing analysis priorities",
                  "Prof Dev" = "",
                  "Sick" = "Appts for child"
)  
...
nextSteps <- 
  "
* Become competent in new training workflow (that doesn't use 'caret') DONE
* Update select models using 'tidymodels' and 'xgboost' (instead of 'caret') IN PROGRESS
