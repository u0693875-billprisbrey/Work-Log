# Email for week starting 02.09.2026  
...
explanations <- c("Job Mngt" = "New laptop (backing up old; setting up new)", "Predict Math Success" = "Reports on grades, courses, and predictors over time updated with new 'dist' measure; Writing summaries",
                  "Travel" = "Retrieving new laptop")  
