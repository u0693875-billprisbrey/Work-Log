# Email for week starting 12.29.2025
...
explanations <- c("Job Mngt" = "Daily planning; tallying vacations", "Predict Math Success" = "Modifying course guide; improving graphics; creating individualized recommendation template")
...
agendaItems <- 
  ...
  * Discuss bi-weekly Kronos replacement (no more reminders?)
"
