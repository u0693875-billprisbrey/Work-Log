# Email for week starting 04.27.2026  
...
explanations <- c("Job Mngt" = "UAIR meetings; support tickets; planning and logs", 
                  "Forecast Completion Rates" = "Learning institutional research methods; duplicating IPEDS numbers; simple extrapolation with quadratic fit" 
)  
