# Email for week starting 07.27.2026  
...
explanations <- c("Job Mngt" = "Daily planning",
                  # "Holiday" = "Memorial Day",
                  "Vacation" = "Vacation",
                 #  "Sick" = "Dr Appt",
                 #  "Travel" = "Internal networking",
                  "Forecast Completion Rates" = "Upgrading forecast models to use factors; using SHAP values to find drivers; writing forecast drivers report" 
)  
