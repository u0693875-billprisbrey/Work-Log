# Email for week starting 11.24.2025
...
explanations <- c("Holiday" = "holiday", "Job Mngt" = "Planning; weekly 1x1", "Predict Math Success" = "Comparing model predictions; improving reports; counter-factuals", "Vacation" = "vacation")
...
* Post reports to Dropbox and distribute them to team. 
* Review HR guidelines and put together a plan for title change to Senior/Lead/Principal Data Scientist 
"

agendaItems <- 
  "
  * Review prediction of 'W' outcomes 
  * Review counterfactuals and guidelines  
"
